...
contract Sepolia_0_BaseContracts is Proposal {
    function name() public view virtual returns (string memory) {
        return "Sepolia_0_BaseContracts";
    }

    constructor() {
        require(
            block.chainid == 11155111,
            "Sepolia_0_BaseContracts: wrong chain id"
        );
    }
    ...
    uint256 internal DELEGATE_LOCKUP_PERIOD = 15 minutes;

    /// @notice rough estimate of seconds per block
    uint256 public SEC_PER_BLOCK = 12;

    // governance params
    uint256 public DAO_TIMELOCK_DELAY = 10 minutes;
    uint256 public ONBOARD_TIMELOCK_DELAY = 10 minutes;
    uint256 public DAO_GOVERNOR_GUILD_VOTING_DELAY = 0;
    uint256 public DAO_GOVERNOR_GUILD_VOTING_PERIOD = 10 minutes / SEC_PER_BLOCK;
    ...
    uint256 public ONBOARD_GOVERNOR_GUILD_VOTING_DELAY = 0;
    uint256 public ONBOARD_GOVERNOR_GUILD_VOTING_PERIOD = 10 minutes / SEC_PER_BLOCK;
