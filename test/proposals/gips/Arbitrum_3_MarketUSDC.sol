...
contract Arbitrum_2_MarketUSDC is Proposal {
    function name() public view virtual returns (string memory) {
        return "Arbitrum_2_MarketUSDC";
    }

    constructor() {
        require(
            block.chainid == 42161,
            "Arbitrum_2_MarketUSDC: wrong chain id"
        );
    }
